...
\inputcode{readchar}{1_Basic/Default_code.cpp}
\inputcode{Pragma Optimization}{1_Basic/Pragma.cpp}
\inputcode{readchar}{1_Basic/readchar.cpp}
\inputcode{Shell script}{1_Basic/Shell_script.cpp}
...
\inputcode{DSU}{3_Data_Structure/DSU.cpp}
...
\inputcode{Dinic}{4_Flow_Matching/Dinic.cpp} % test by Lib-Checker Matching on Bipartite Graph
